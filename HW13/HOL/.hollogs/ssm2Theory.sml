...
<<HOL message: Created theory "ssm2">>
Saved theorem _____ "datatype_configuration2"
Saved theorem _____ "configuration2_11"
Saved theorem _____ "configuration2_case_cong"
Saved theorem _____ "configuration2_nchotomy"
Saved theorem _____ "configuration2_Axiom"
Saved theorem _____ "configuration2_induction"
<<HOL message: Defined type: "configuration2">>
Saved theorem _____ "configuration2_one_one"
...
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("CFG2Interpret_tupled")
  invalidated by DelConstant(ssm2$CFG2Interpret_tupled)>>
Saved definition __ "CFG2Interpret_def"
Saved induction ___ "CFG2Interpret_ind"
Saved theorem _____ "TR2_rules"
Saved theorem _____ "TR2_ind"
Saved theorem _____ "TR2_strongind"
Saved theorem _____ "TR2_cases"
Saved theorem _____ "TR2_EQ_rules_thm"
Saved theorem _____ "TR2rule0"
Saved theorem _____ "TR2rule1"
Saved theorem _____ "TR2_discard_cmd_rule"
Saved theorem _____ "TR2_exec_cmd_rule"
Saved theorem _____ "TR2_trap_cmd_rule"
Saved theorem _____ "TR2_iff_TR_discard_thm"
Saved theorem _____ "TR2_iff_TR_exec_thm"
Saved theorem _____ "TR2_iff_TR_trap_thm"
Exporting theory "ssm2" ... done.
Theory "ssm2" took 3.8s to build
Theory: ssm2
...
Term constants:
    CFG2                  :('input ->
                            ('command inst, 'principal, δ, ε) Form) ->
                           ('cert ->
                            ('command inst, 'principal, δ, ε) Form) ->
                           (('command inst, 'principal, δ, ε) Form ->
                            bool) ->
                           ...
                           'state ->
                           'output list ->
                           ('cert, 'command, δ, ε, 'input, 'output,
                            'principal, 'state) configuration2
    CFG2Interpret         :('command inst, β, 'principal, δ, ε) Kripke #
                           δ po # ε po ->
                           ('cert, 'command, δ, ε, 'input, 'output,
                            'principal, 'state) configuration2 -> bool
    TR2                   :('command inst, β, 'principal, δ, ε) Kripke #
                           δ po # ε po ->
                           'command trType ->
                           ('cert, 'command, δ, ε, 'input, 'output,
                            'principal, 'state) configuration2 ->
                           ('cert, 'command, δ, ε, 'input, 'output,
                            'principal, 'state) configuration2 -> bool
    configuration2_CASE   :('cert, 'command, δ, ε, 'input, 'output,
                            'principal, 'state) configuration2 ->
                           (('input ->
                             ('command inst, 'principal, δ, ε) Form) ->
                            ('cert ->
    ...
    configuration2_size   :('cert -> num) ->
                           ...
                           ('state -> num) ->
                           ('cert, 'command, δ, ε, 'input, 'output,
                            'principal, 'state) configuration2 -> num
    ...
    TR2_def
      |- TR2 =
         (λa0 a1 a2 a3.
            ∀TR2'.
              (∀a0 a1 a2 a3.
                 (∃inputInterpret certInterpret inputTest x NS M Oi Os
                     Out state certs stateInterpret cmd ins outStream.
...
Theorems:
    ...
    TR2_discard_cmd_rule
      |- TR2 (M,Oi,Os) discard
         ...
         ¬inputTest (inputInterpret x)
    TR2_exec_cmd_rule
      |- ∀inputInterpret certInterpret inputTest certs stateInterpret x
            cmd ins state outStream.
           (∀M Oi Os.
              CFG2Interpret (M,Oi,Os)
                (CFG2 inputInterpret certInterpret inputTest certs
                   stateInterpret (x::ins) state outStream) ⇒
      ...
      |- ∀inputInterpret certInterpret inputTest certs certs2
           ...
           (∀M Oi Os.
              CFGInterpret (M,Oi,Os)
                (CFG inputTest stateInterpret certs
                   (inputInterpret x::ins) state outStream) ⇒
              (M,Oi,Os) sat prop (SOME cmd)) ⇒
           (∀M Oi Os.
              CFG2Interpret (M,Oi,Os)
                (CFG2 inputInterpret certInterpret inputTest certs2
           ...
           (∀inputInterpret certInterpret inputTest x NS M Oi Os Out
              ...
              TR2' (M,Oi,Os) (trap cmd)
                ...
                (CFG2 inputInterpret certInterpret inputTest certs
                   ...
                   (Out state (trap cmd)::outStream))) ∧
           (∀inputInterpret certInterpret inputTest x NS M Oi Os Out
               state certs stateInterpret ins outStream.
              ¬inputTest (inputInterpret x) ⇒
              TR2' (M,Oi,Os) discard
                (CFG2 inputInterpret certInterpret inputTest certs
                   stateInterpret (x::ins) state outStream)
    ...
    configuration2_Axiom
      |- ∀f.
           ∃fn.
             ∀a0 a1 a2 a3 a4 a5 a6 a7.
               fn (CFG2 a0 a1 a2 a3 a4 a5 a6 a7) =
               f a0 a1 a2 a3 a4 a5 a6 a7
    configuration2_case_cong
      |- ∀M M' f.
           (M = M') ∧
           (∀a0 a1 a2 a3 a4 a5 a6 a7.
    ...
    configuration2_induction
      |- ∀P.
           (∀f f0 f1 l f2 l0 s l1. P (CFG2 f f0 f1 l f2 l0 s l1)) ⇒
           ∀c. P c
    configuration2_nchotomy
      |- ∀cc. ∃f f0 f1 l f2 l0 s l1. cc = CFG2 f f0 f1 l f2 l0 s l1
    configuration2_one_one
      |- ∀a0 a1 a2 a3 a4 a5 a6 a7 a0' a1' a2' a3' a4' a5' a6' a7'.
           (CFG2 a0 a1 a2 a3 a4 a5 a6 a7 =
            CFG2 a0' a1' a2' a3' a4' a5' a6' a7') ⇔
           (a0 = a0') ∧ (a1 = a1') ∧ (a2 = a2') ∧ (a3 = a3') ∧
           (a4 = a4') ∧ (a5 = a5') ∧ (a6 = a6') ∧ (a7 = a7')
    datatype_configuration2
      |- DATATYPE (configuration2 CFG2)
Completed load of ssm2Script

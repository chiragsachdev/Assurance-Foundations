...
<<HOL message: Created theory "SM0r2">>
<<HOL message: mk_functional: 
  pattern completion has added 57 clauses to the original specification.>>
Saved definition __ "inputOKr2_def"
Saved induction ___ "inputOKr2_ind"
Saved definition __ "certsr2root_def"
Saved definition __ "certsr2signed_def"
Saved definition __ "certsr2_def"
<<HOL message: mk_functional: 
  pattern completion has added 56 clauses to the original specification.>>
Saved definition __ "mapSM0r1input_def"
Saved induction ___ "mapSM0r1input_ind"
Saved theorem _____ "mapSM0r1_Bob_Operator_privcmd_lemma"
Saved theorem _____ "Operator_Bob_exec_privcmd_justified_thm_r2"
Saved theorem _____ "Operator_mapSM0r1input_exec_privcmd_justifed_thm"
Exporting theory "SM0r2" ... done.
Theory "SM0r2" took 18.0s to build
Completed load of SM0r2Script

...
<<HOL message: Created theory "ssm1">>
Saved theorem _____ "datatype_inst"
Saved theorem _____ "inst_11"
Saved theorem _____ "inst_distinct"
Saved theorem _____ "inst_case_cong"
Saved theorem _____ "inst_nchotomy"
Saved theorem _____ "inst_Axiom"
Saved theorem _____ "inst_induction"
<<HOL message: Defined type: "inst">>
Saved theorem _____ "inst_distinct_clauses"
Saved theorem _____ "inst_one_one"
Saved theorem _____ "datatype_trType"
Saved theorem _____ "trType_11"
Saved theorem _____ "trType_distinct"
Saved theorem _____ "trType_case_cong"
Saved theorem _____ "trType_nchotomy"
Saved theorem _____ "trType_Axiom"
Saved theorem _____ "trType_induction"
<<HOL message: Defined type: "trType">>
Saved theorem _____ "trType_distinct_clauses"
Saved theorem _____ "trType_one_one"
...
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("CFGInterpret_tupled")
  invalidated by DelConstant(ssm1$CFGInterpret_tupled)>>
Saved definition __ "CFGInterpret_def"
Saved induction ___ "CFGInterpret_ind"
Saved theorem _____ "TR_rules"
Saved theorem _____ "TR_ind"
Saved theorem _____ "TR_strongind"
Saved theorem _____ "TR_cases"
Saved theorem _____ "TR_EQ_rules_thm"
Saved theorem _____ "TRrule0"
Saved theorem _____ "TRrule1"
Saved theorem _____ "TR_discard_cmd_rule"
Saved theorem _____ "TR_exec_cmd_rule"
Saved theorem _____ "TR_trap_cmd_rule"
Exporting theory "ssm1" ... done.
Theory "ssm1" took 1.4s to build
Theory: ssm1
...
Term constants:
    CFG                  :(('command inst, 'principal, δ, ε) Form ->
                           bool) ->
                          ('state ->
                           ('command inst, 'principal, δ, ε) Form) ->
                          ('command inst, 'principal, δ, ε) Form list ->
                          ('command inst, 'principal, δ, ε) Form list ->
                          'state ->
                          'output list ->
                          ('command, δ, ε, 'output, 'principal, 'state)
                          configuration
    CFGInterpret         :('command inst, β, 'principal, δ, ε) Kripke #
                          δ po # ε po ->
                          ('command, δ, ε, 'output, 'principal, 'state)
                          configuration -> bool
    NONE                 :'command inst
    SOME                 :'command -> 'command inst
    TR                   :('command inst, β, 'principal, δ, ε) Kripke #
                          δ po # ε po ->
                          'command trType ->
                          ('command, δ, ε, 'output, 'principal, 'state)
                          configuration ->
                          ('command, δ, ε, 'output, 'principal, 'state)
                          configuration -> bool
    configuration_CASE   :('command, δ, ε, 'output, 'principal, 'state)
                          configuration ->
                          ((('command inst, 'principal, δ, ε) Form ->
                            bool) ->
                           ('state ->
                           ...
                           ->
                           ('command inst, 'principal, δ, ε) Form list
                           -> 'state -> 'output list -> α) -> α
    configuration_size   :('command -> num) ->
                          (δ -> num) ->
                          (ε -> num) ->
                          ('output -> num) ->
                          ('principal -> num) ->
    ...
    exec                 :'command -> 'command trType
    inst_CASE            :'command inst -> ('command -> α) -> α -> α
    inst_size            :('command -> num) -> 'command inst -> num
    trType_CASE          :'command trType ->
                          α -> ('command -> α) -> ('command -> α) -> α
    trType_size          :('command -> num) -> 'command trType -> num
    trap                 :'command -> 'command trType
...
Definitions:
    ...
    inst_size_def
      |- (∀f a. inst_size f (SOME a) = 1 + f a) ∧
         ∀f. inst_size f NONE = 0
    trType_TY_DEF
      |- ∃rep.
           TYPE_DEFINITION
             (λa0.
